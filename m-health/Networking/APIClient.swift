...
class APIClient {
    ...
    class func sendRequest2(path: String, httpMethod: HTTPMethod ,parameters: Dictionary<String, Any>, success: @escaping (_ response: Any?) -> Void, failure: @escaping (_ error: LLError) -> Void){
        ...
        //        debugPrint("request fired : \(Date())")
        Alamofire.request(requestURL, method: httpMethod,parameters:parameters, headers:headers).responseJSON { response in
