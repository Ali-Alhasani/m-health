//
//  MHAddRadiologyViewController.swift
//  m-health
//
...
import UIKit
protocol AddRadiologyViewControllerDelegate: class {
    
    func RadiologyViewController(_ controller: MHAddRadiologyViewController, didFinishAdding item: Radiology)
    
    
}
class MHAddRadiologyViewController: UIViewController,UITextViewDelegate {
    weak var delegate: AddRadiologyViewControllerDelegate?
    ...
    @IBAction func addButtonAction(_ sender: Any) {
        ...
        if (nameText.text?.isEmpty)! {
            let alert = UIAlertController(title: "Alert", message: "Please enter radiology name", preferredStyle: .alert)
        ...
        delegate?.RadiologyViewController(self, didFinishAdding: radiology)
        }
    }
